...
# bash 3_main_ex_per_seed.sh > 3_main_ex_per_seed.out 2>&1 &
...
# COUNT EX PER SEED
start=`date +%s`
global_path=/home/pauline/Bureau/MNHN_RESULT/2_EXAMPLES
...
start=`date +%s`
path_original=/home/pauline/Bureau/MNHN_RESULT/2_EXAMPLES/num_ex.csv
path_target=/home/pauline/Bureau/MNHN_RESULT/2_EXAMPLES/frac_ex.csv
