...
DATA_RESULT            = f"{file.parents[2]}/MNHN_RESULT/5_SCORE_{args.methode}"  # chemin du dossier des sorties de calcul de score
...
# un dico exemple par test (à mettre dans fichier temporaire?)
# ou ne pas les enregistrer (juste utilisé le temps d'un test ...)
# path_dico_exemple = path_res_folder 
