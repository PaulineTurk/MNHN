...
def example_number_per_seed(path_dico_seed_normalised, nb_exemple_test):
    """
    ...
    # si je décide de ne plus enregistrer les exemples test selectionnées
...
def multi_random_example_selection(path_folder_seed, dico_exemple, 
    ...
    diff = end-start
    items_per_second = nb_files/diff       # Attention, ici partout c faux, c'est l'inverse !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
