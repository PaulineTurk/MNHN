...
DATA_RESULT            = f"{DATA_RESULT_GLOBAL}/5_SCORE_{methode}"  # chemin du dossier des sorties de calcul de score
...
for i, tranche in enumerate(liste_tranche):
    ...
    #path_data_graph = f"{DATA_RESULT}/Experience_Brier_{pid_inf}_{pid_sup}_mini_test/Reference_{reference}"
